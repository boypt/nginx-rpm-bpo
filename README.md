...
4. CI builds RPMs for el5 (x86_64 + i686)/el6/el7 plus `aarch64_el7` (now 5 artifacts total: el5 x86_64, el5 i686, el6, el7, aarch64_el7), uploads artifacts, and creates a GitHub Release. The `build-arm64` job runs `aarch64_el7` natively on `ubuntu-24.04-arm`.
